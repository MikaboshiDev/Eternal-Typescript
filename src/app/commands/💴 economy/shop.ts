         ...
         return subCommand
            ...
            .addStringOption((str) => {
               return str
                  .setName('name')
                  .setDescription(
                     'the name of the product. (not the identifier)'
                  )
                  .setRequired(true);
            })
            .addStringOption((str) => {
            ...
            .addRoleOption((option) =>
               option
                  .setName('role')
                  .setDescription(
                     'Give the user this role when he uses this item!'
                  )
            )
         ...
         return subCommand
            ...
            .addStringOption((option) => {
               return option
                  .setName('identifier')
                  .setDescription(
                     'The identifier of the item you want to remove'
                  );
            });
      }),
      ...
      switch (options.getSubcommand()) {
         case 'add':
            ...
            const itemIdentifier =
               options.getString('identifier') || generateToken(5);
                  ...
                  return await interaction.reply({
                     embeds: [
                        new EmbedBuilder().setDescription(
                           'This item has no price or role!'
                        ),
                     ],
                  });
               }
